...
<body>
	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<div class="col-sm-9">
				<!-- show the loai -->
				<?php require '../ad_site/ad_action/ac_showTheLoai.php'; ?>
				<!-- /.show the loai -->
					...
					<table class="table table-bordered text-left">
						...
						<tbody>
							<tr>
								...
								<td>Otto</td>
								<td>@mdo</td>
								<td class="text-center"><a href="updateTheLoai.php"><span class="glyphicon glyphicon-edit" style="font-size: 20px"></span></a></td>
