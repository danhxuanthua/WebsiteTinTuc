...
<?php 
    if(isset($_GET['id'])){
		$tenKhongDau = $_GET['id'];
		$qsl_tinTuc = "SELECT tt.id, tt.TieuDe, tt.TieuDeKhongDau, tt.TomTat, tt.NoiDung, tt.Hinh, tt.NoiBat, tt.SoLuotXem, tt.idLoaiTin, tt.created_at FROM tintuc tt, loaitin lt, theloai tl WHERE tt.idLoaiTin = lt.id AND tl.id=lt.idTheLoai AND tt.idLoaiTin=$id ORDER BY tt.id DESC LIMIT $start, $limit";
